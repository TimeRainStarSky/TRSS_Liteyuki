...
download(){ case "$N" in
  ...
  4)Server="Coding" URL="https://trss.coding.net/p/TRSS/d/Liteyuki/git/raw/main";;
  5)Server="GitLab" URL="https://gitlab.com/TimeRainStarSky/TRSS_Liteyuki/raw/main";;
  6)Server="GitCode" URL="https://gitcode.net/TimeRainStarSky1/TRSS_Liteyuki/raw/main";;
  7)Server="GitLink" URL="https://gitlink.org.cn/api/TimeRainStarSky/TRSS_Liteyuki/raw?ref=main&filepath=";;
  8)Server="JiHuLab" URL="https://jihulab.com/TimeRainStarSky/TRSS_Liteyuki/raw/main";;
  9)Server="Jsdelivr" URL="https://cdn.jsdelivr.net/gh/TimeRainStarSky/TRSS_Liteyuki@main";;
  10)Server="Bitbucket" URL="https://bitbucket.org/TimeRainStarSky/TRSS_Liteyuki/raw/main"
esac
echo "
...
WORKDIR /root/TRSS_Liteyuki'>Dockerfile
...
docker run -itd -h TRSS-Liteyuki --name $DKNAME -v "$DIR":/root/TRSS_Liteyuki --restart always $([ $DKNAME = TRSS_Liteyuki ]&&echo "-p 13579:13579"||echo "-p 13579") trss:liteyuki||abort "Docker 容器启动失败"
mkdir -vp "$CMDPATH"&&
