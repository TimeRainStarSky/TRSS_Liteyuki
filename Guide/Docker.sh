...
download(){ case "$N" in
  2)SERVER="GitHub";URL="https://github.com/TimeRainStarSky/TRSS_Liteyuki/raw/main";;
  1)SERVER="Gitee";URL="https://gitee.com/TimeRainStarSky/TRSS_Liteyuki/raw/main";;
  3)SERVER="Agit";URL="https://agit.ai/TimeRainStarSky/TRSS_Liteyuki/raw/branch/main";;
  4)SERVER="GitLab";URL="https://gitlab.com/TimeRainStarSky/TRSS_Liteyuki/raw/main";;
  5)SERVER="Coding";URL="https://trss.coding.net/p/TRSS/d/Liteyuki/git/raw/main";;
  6)SERVER="Aliyun";URL="https://code.aliyun.com/TimeRainStarSky/TRSS_Liteyuki/raw/main";;
  7)SERVER="GitCode";URL="https://gitcode.net/TimeRainStarSky1/TRSS_Liteyuki/raw/main";;
  8)SERVER="JiHuLab";URL="https://jihulab.com/TimeRainStarSky/TRSS_Liteyuki/raw/main";;
  9)SERVER="Bitbucket";URL="https://bitbucket.org/TimeRainStarSky/TRSS_Liteyuki/raw/main";;
  10)SERVER="Jsdelivr";URL="https://cdn.jsdelivr.net/gh/TimeRainStarSky/TRSS_Liteyuki@main"
  esac;echo "
...
$B  最新版本：$G$NEWNAME$C ($NEWVER)$O
  ...
  开始下载";mkdir -vp "$DIR";geturl "$URL/Main.sh">"$DIR/Main.sh"||abort_update "下载失败";[ "$(md5sum "$DIR/Main.sh"|head -c 32)" != "$MD5" ]&&abort_update "下载文件校验错误";echo -n "bash '$DIR/Main.sh' "'"$@"'>/bin/tsly||abort "脚本执行命令/bin/tsly设置失败";chmod 755 /bin/tsly||abort "脚本权限设置失败";echo "
$G- 脚本下载完成$O";}
echo "
...
COPY Main.sh /root/TRSS_Liteyuki/Main.sh
COPY tsly /bin
...
docker run -itd --restart=always --name TRSS_Liteyuki trss:liteyuki
echo -n "docker exec -it TRSS_Liteyuki bash '$DIR/Main.sh' "'"$@"'>/bin/tsly||abort "脚本执行命令/bin/tsly设置失败";chmod 755 /bin/tsly||abort "脚本权限设置失败";echo "
$G- Docker 容器安装完成，输入tsly执行$O";exit;}